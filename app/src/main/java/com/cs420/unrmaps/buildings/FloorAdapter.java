...
public class FloorAdapter extends ArrayAdapter<Integer> {
    ...
    public FloorAdapter(Activity context, ArrayList<Integer> floors, RelativeLayout container) {
    ...
    private void zoomImageFromThumb(final View thumbView, int imageResId) {
        ...
        final ImageView expandedImageView = (ImageView) container.findViewById(R.id.expanded_image);
